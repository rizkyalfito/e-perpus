...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            ...
            <h3 class="text-center" style="margin-top: 0; margin-bottom: 20px;">Lupa Password</h3>
            
            <form name="formLupaPassword" action="function/Process.php?aksi=lupa_password" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                ...
                <div class="form-group has-feedback">
                    ...
                    <select class="form-control" name="security_question" required>
                        ...
                        <option value="1">Apa nama hewan peliharaan pertama Anda?</option>
                        <option value="2">Di kota mana Anda lahir?</option>
                        <option value="3">Apa nama sekolah dasar Anda?</option>
                        <option value="4">Siapa nama ibu kandung Anda?</option>
                    </select>
                </div>
                
                <div class="form-group has-feedback">
                    <label>Jawaban Keamanan</label>
                    <input type="text" class="form-control" name="security_answer" id="security_answer" placeholder="Masukkan jawaban Anda" required>
    ...
    <script>
        function validateForm() {
            var newPassword = document.forms["formLupaPassword"]["new_password"].value;
            var confirmPassword = document.forms["formLupaPassword"]["confirm_password"].value;
